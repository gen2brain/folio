// Code generated by tools/gentables from Adobe Glyph List, specs/agl-aglfn-master/{glyphlist,zapfdingbats}.txt. DO NOT EDIT.

package font

// glyphList has 4281 entries.
var glyphList = map[string]string{
	"A":                                   "A",
	"AE":                                  "Æ",
	"AEacute":                             "Ǽ",
	"AEmacron":                            "Ǣ",
...
// dingbatsList has 201 entries.
var dingbatsList = map[string]string{
	"a1":   "✁",
	"a10":  "✡",
	"a100": "❞",
	"a101": "❡",
